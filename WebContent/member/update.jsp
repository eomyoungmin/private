...
<div class="content">
 ...
 <form action="../main/main.jsp" id="join" method="post" name="fr">
 <fieldset>
 <input type="text" name="id" class="inpt" required="required" value="<%=id%>" readonly>
 <label for="email">Your ID</label>
 <input type="password" name="pass" class="inpt" required="required" placeholder="Password">
 <label for="email">Your Pass</label>
  <input type="password" name="pass" class="inpt" required="required" placeholder="Retype pass">
 <label for="email">Retype Pass</label>
 <input type="text" name="name" class="inpt" required="required" value="<%=mb.getName()%>" >
 <label for="email">Your Name</label>
 <input type="text" name="email" class="inpt" required="required" value="<%=mb.getEmail()%>">
 <label for="email">Your E-mail</label>
 </fieldset>
 <fieldset>
 <legend>Optional</legend>
 <input type="text" name="address" class="inpt" required="required" value="<%=mb.getAddress()%>">
 <label for="email">Your Address</label>
 <input type="text" name="phone" class="inpt" required="required" value="<%=mb.getPhone()%>">
 <label for="email">Your Phone</label>
 <input type="text" name="mobile" class="inpt" required="required" value="<%=mb.getMobile()%>">
 <label for="email">Mobile Number</label>
 </fieldset>
<div class="submit-wrap">
<input type="submit" value="변경" class="submit">
<a href="../member/deleteForm.jsp">회원정보 삭제</a>
</div>
 </form>
  </div>
</div>
...
function idCheck(){
	var win=window.open("idCheckForm.jsp", "id", "width=400, height=350");
 }
